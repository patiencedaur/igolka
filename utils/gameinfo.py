...
class GameInfo:
    ...
    def create_url_dict(self, url='https://boardgamegeek.com/collection/user/DarkyLondon?own=1&subtype=boardgame&ff=1'):
        '''
